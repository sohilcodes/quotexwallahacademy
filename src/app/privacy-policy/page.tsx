...
export const metadata: Metadata = {
  title: "Privacy Policy | Quotex Wallah Academy",
  description: "Privacy Policy for Quotex Wallah Academy.",
};
      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        >
          <section>
            ...
            <p>
              Welcome to Quotex Wallah Academy. We are committed to protecting
          ...
          <section>
            <h2>8. Disclaimer</h2>
            <p>
              All content on Quotex Wallah Academy is for educational purposes
