...
export const metadata: Metadata = {
  title: "About | Quotex Wallah Academy",
  description:
    "Learn about Quotex Wallah Academy — our mission to provide professional trading education for every level of trader.",
};
      ...
      <section className="max-w-5xl mx-auto px-4 mb-20 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-black text-white mb-6">
          ...
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">
            Quotex Wallah Academy
          </span>
        </h1>
        <p className="text-zinc-400 text-lg max-w-3xl mx-auto leading-relaxed">
          Quotex Wallah Academy was built with one mission — to make professional
      ...
      <section className="max-w-5xl mx-auto px-4 mb-20">
        <div className="glass-card rounded-3xl p-10 border border-white/5 grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-zinc-400 leading-relaxed mb-4">
              At Quotex Wallah Academy, we focus on the fundamentals — price
      ...
      <section className="max-w-4xl mx-auto px-4 mb-16">
        <div className="glass-card rounded-2xl p-8 border border-amber-500/20 bg-amber-500/5">
          ...
          <p className="text-zinc-400 text-sm leading-relaxed">
            All content published on Quotex Wallah Academy is for educational
      ...
      <section className="max-w-3xl mx-auto px-4 text-center">
        <div className="rounded-2xl p-10 border border-emerald-500/30 bg-emerald-500/5">
          ...
          <p className="text-zinc-400 mb-6">
            ...
            part of the Quotex Wallah Academy community.
          </p>
          <a
            href="https://t.me/+s539iCl1B300ZWJl"
            target="_blank"
